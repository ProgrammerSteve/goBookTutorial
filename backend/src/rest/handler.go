...
func (h *Handler) SignIn(c *gin.Context) {
	...
	//checks request body and tries to fill out our customer variable with it
...
func (h *Handler) Charge(c *gin.Context) {
	...
	chargeP := &stripe.ChargeParams{
		...
		Description: stripe.String("Go Music charge..."),
	}
	stripeCustomerID := ""
	...
	/*
		we should check if the customer already ordered the same item or not
		but for simplicity, let's assume it's a new order
	*/
